...
def test_lanenet(image_path, weights_path):
    ...
    with sess.as_default():
        ...
        saved_binary = binary_seg_image[0] * 255
        plt.imshow(saved_binary)
        cv2.imwrite('/media/st/4297-ED06/binary_res/24.jpg', saved_binary)
...
if __name__ == '__main__':
    ...
    # init args
    args = init_args()
    args.image_path = '/media/st/8CEA-E915/xy_gc/12_20/0.png'
    args.weights_path = '/media/st/8CEA-E915/Weights/CU_xy_new_500/tusimple_train.ckpt'
