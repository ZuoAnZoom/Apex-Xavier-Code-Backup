...
StereoCamParam_t CStereoVisionForADAS::InitStereoParam(int nDatasetName)
{
	...
	else if (nDatasetName == benben2)
	{
		...
		objStereoCamParam.m_dMaxDist = 50.;  //70
		objStereoCamParam.m_nNumberOfDisp = 48; //80
		objStereoCamParam.m_nWindowSize = 7; //13
		objStereoCamParam.objCamParam.m_dCameraHeight = 1.165;			//TBD..
		...
		objStereoCamParam.objCamParam.m_sizeSrc = cv::Size(1280/2, 720/2);//250,300
		//c = objStereoCamParam.objCamParam.m_sizeSrc.width ;
	}

	// else if (nDatasetName == benben3)
	// {
	// 	objStereoCamParam.m_dBaseLine = 0.4156;
	// 	objStereoCamParam.m_dMaxDist = 70.;
	// 	objStereoCamParam.m_nNumberOfDisp = 112;
	// 	objStereoCamParam.m_nWindowSize = 11;
	// 	objStereoCamParam.objCamParam.m_dCameraHeight = 1.165;			//TBD..
	// 	objStereoCamParam.objCamParam.m_dFocalLength = 858.651454;
	// 	objStereoCamParam.objCamParam.m_dPitchDeg = -2;	///< ������ ���׷��� ����� ������ �ݴ�� ��. ���׷��� ����
	// 	objStereoCamParam.objCamParam.m_dYawDeg = 0;
	// 	objStereoCamParam.objCamParam.m_dOx = 309.762;
	// 	objStereoCamParam.objCamParam.m_dOy = 214.587;
	// 	objStereoCamParam.objCamParam.m_sizeSrc = cv::Size(720, 480);
	// 	//c = objStereoCamParam.objCamParam.m_sizeSrc.width ;
	// }
	...
	else if (nDatasetName == benben3)
	{
		...
		objStereoCamParam.objCamParam.m_dCameraHeight = 1.165;			//TBD..
		objStereoCamParam.objCamParam.m_dFocalLength = 1231.5846;
		objStereoCamParam.objCamParam.m_dPitchDeg = -1;	///< ������ ���׷��� ����� ������ �ݴ�� ��. ���׷��� ����
		objStereoCamParam.objCamParam.m_dYawDeg = 0;
...
int CStereoVisionForADAS::Objectness(Mat& imgLeft, Mat& imgRight)
{
	...
	cv::Size src = cv::Size(m_imgLeftInput.cols, m_imgLeftInput.rows);
	m_imgColorDisp = Mat(src, CV_8UC3);
	m_imgColorDisp = Scalar(0);
...
void CStereoVisionForADAS::Display(Mat& imgDisplay, Mat& imgStixelResult) 
{
	...
	for (unsigned int i = 0; i < m_vecobjBB.size(); i++)
	{
		rectangle(imgDisplay, m_vecobjBB[i].rectBB, Scalar::all(255 - m_vecobjBB[i].dZ / fBrightness * 255), 2, 8);//8
	}
