...
def test_lanenet(image_path, weights_path):
    ...
    image_edge = cv2.Canny(image_gray, 120, 250)
    ...
    with sess.as_default():
        ...
        binary_seg_image, instance_seg_image = sess.run(
            ...
            feed_dict={input_tensor: [image_edge]}
        )
...
if __name__ == '__main__':
    ...
    args.weights_path = '/media/st/9C20-06C6/Weights/CU_xy_pure_edge/tusimple_train.ckpt'
